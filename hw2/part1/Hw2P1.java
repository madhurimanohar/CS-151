...
public class Hw2P1{   
    ...
    private static Shape carShape()   {      
        ...
        = new Ellipse2D.Double(WIDTH * 2 / 3, WIDTH / 3,            
                WIDTH / 6, WIDTH / 6);      // the bottom of the front windshield      
        Point2D.Double r1         
        = new Point2D.Double(WIDTH / 6, WIDTH / 6);      // the front of the roof      
        Point2D.Double r2         = new Point2D.Double(WIDTH / 3, 0);      // the rear of the roof      
        Point2D.Double r3         = new Point2D.Double(WIDTH * 2 / 3, 0);      // the bottom of the rear windshield      
